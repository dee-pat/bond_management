...
frappe.query_reports["Portfolio Performance"] = {
    ...
    formatter(value, row, column, data, default_formatter) {
        ...
        return `<button class="btn btn-link btn-xs portfolio-cashflow-copy" data-isin="${frappe.utils.escape_html(data.isin)}" data-xirr-type="${column.fieldname === "xirr" ? "past" : "future"}" title="Copy cash flows for Excel">${formatted_value}</button>`;
    },
    onload(report) {
